...
addCustomerForm.addEventListener('submit', function(e) {
	...
	'action' : 'addCustomer'}, '../ajaxPhp/customers.php', function(response) {
		if(response == 'success') {
			addCustomerForm.reset();
			displayResult('Customer successfully added.', 'success', 'alert-dismissible fade show mt-4 mx-md-4', true);
		}
